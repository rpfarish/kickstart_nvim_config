return {
  ...
  config = function()
    ...
    keymap('n', '<leader>gv', ':Gvdiffsplit<CR>', { desc = '[G]it Vertical [D]iff split' })
    ...
    -- TODO: Doesn't work getting git file history
    -- keymap('n', '<leader>gfh', ':Git log -- %<CR>', { desc = '[G]it [C]ommit history of [F]ile' })
    --
    -- -- Push / Pull
